...
const deletedata=(id)=>{
  axios.delete(`http://localhost:9001/Product/delete/${id}`).then(response=>{
...
const handleok=()=>{
  axios.put("http://localhost:9001/Product/edit",editdata).then(response=>{
    console.log("updated")
    ...
    useEffect(()=>{
        axios.get("http://localhost:9001/Product/getproducts").then(response=>{
